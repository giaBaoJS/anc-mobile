...
import { CELL_COUNT } from './FactorMobileCodeScreen';
import { AuthRegisterValidationField, UserInfoField } from '../../models/Auth';
...
const FactorMobileCodeView = ({
  ...
  return (
    <View style={[Layout.container]}>
      ...
      <Header name={i18next.t('FactorMobileCodeScreen.Title')} />
        ...
        <ScrollView contentContainerStyle={styles.container}>
          <View style={styles.typingText}>
            <SemiBoldText style={styles.title}>
              {i18next.t('FactorMobileCodeScreen.Header')}
            </SemiBoldText>
            <RegularText style={styles.welcomeText}>
              {i18next.t('FactorMobileCodeScreen.Welcome')}
            </RegularText>
            <RegularText>({userInfo?.phone.phone_full})</RegularText>
          </View>
          <CodeField
            ref={ref}
            {...codeProp}
...
export default FactorMobileCodeView;
