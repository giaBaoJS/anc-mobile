...
// Constant String
export const HOME_DASHBOARD_ANC_UTILITIES_WIDGET =
  'HOME_DASHBOARD_ANC_UTILITIES_WIDGET';
export const HOME_DASHBOARD_ANC_PUBLIC_PROJECT_WIDGET =
  'HOME_DASHBOARD_ANC_PUBLIC_PROJECT_WIDGET';
export const HOME_DASHBOARD_ANC_NEWS_WIDGET = 'HOME_DASHBOARD_ANC_NEWS_WIDGET';
export const HOME_DASHBOARD_ANC_ABOUT_ANC_WIDGET =
